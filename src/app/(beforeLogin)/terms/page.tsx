    ...
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] flex flex-col justify-between selection:bg-[#FFF3F4] selection:text-[#FF5D7B]">
      <header className="border-b border-slate-200/80 bg-white/80 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <span className="font-extrabold text-sm text-slate-800">서비스 이용약관</span>
        </div>
      </header>

      <main className="max-w-4xl mx-auto px-6 py-12 flex-1 w-full space-y-8">
        <div className="space-y-3 pb-6 border-b border-slate-200">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#F5F1FF] border border-[#8B75F9]/20 text-[#8B75F9] text-xs font-bold">
            <FileText size={14} />
          ...
          <section className="space-y-3">
            ...
            <div className="rounded-2xl border border-slate-200 overflow-hidden bg-slate-50/50">
              <table className="w-full text-left text-xs text-slate-700">
                <thead className="bg-[#FFF3F4] border-b border-slate-200 text-[#FF5D7B] font-bold">
                  <tr>
                ...
                <tbody className="divide-y divide-slate-200">
                  <tr>
                    <td className="py-3 px-4 font-bold text-slate-900">욕설 및 비하</td>
                    <td className="py-3 px-4 text-slate-500">타인 인신공격, 조롱, 혐오 발언</td>
                    <td className="py-3 px-4 text-amber-600 font-semibold">즉시 삭제 및 경고</td>
                    <td className="py-3 px-4 text-[#FF5D7B] font-bold">영구 정지</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 font-bold text-slate-900">도배 및 스팸</td>
                    <td className="py-3 px-4 text-slate-500">의미 없는 연속 글, 상업적 광고</td>
                    <td className="py-3 px-4 text-amber-600 font-semibold">즉시 삭제 및 경고</td>
                    <td className="py-3 px-4 text-[#FF5D7B] font-bold">영구 정지</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 font-bold text-slate-900">신상 유포</td>
                    <td className="py-3 px-4 text-slate-500">실명, 연락처, SNS 무단 노출</td>
                    <td className="py-3 px-4 text-[#FF5D7B] font-semibold">즉시 삭제 & 7일 정지</td>
                    <td className="py-3 px-4 text-[#FF5D7B] font-bold">영구 정지</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 font-bold text-slate-900">허위 신고</td>
                    <td className="py-3 px-4 text-slate-500">무고 유저를 고의로 반복 신고</td>
                    <td className="py-3 px-4 text-amber-600 font-semibold">신고 기능 7일 제한</td>
                    <td className="py-3 px-4 text-[#FF5D7B] font-bold">영구 정지</td>
                  </tr>
                </tbody>
              </table>
